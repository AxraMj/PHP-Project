...
<div>
<input type="text" placeholder="Phone Number" name="phoneno" class="user-input" required="">
</div>
...
if(isset($_REQUEST['submit']))
{
	...
	$a="insert into student(name,address,rollno,dob,gender,email,phoneno,batch) values('$name','$address','$rollno','$dob','$gender','$email','$phoneno','$batch')";
    mysqli_query($conn,$a);
	// echo $a;

	$qry1 = "insert into login(username,password,usertype,status) values('$rollno','$dob','student','requested')";
	// echo $qry1;
